public class zhiLianWork{
	 private String url="http://sou.zhaopin.com/jobs/searchresult.ashx?jl=";  //智联招聘网站
	    private  String city; //搜索工作的城市
	    private  String keywords;  //搜索工作的关键字
	    public zhiLianWork(String city,String keywords){        
	        this.city=city;
	    ...
	    public static void main(String[] args) {    
	    	zhiLianWork jHtml = new zhiLianWork("上海", "java");
